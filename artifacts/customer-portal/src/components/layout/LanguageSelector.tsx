...
const LANGUAGES = [
  ...
  { code: "ar-AE", flag: "🇦🇪", language: "العربية", country: "United Arab Emirates", label: "AR" },
...
export function LanguageSelector({ compact = false }: LanguageSelectorProps) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div
          className="absolute right-0 top-full z-50 mt-2 w-64 overflow-hidden rounded-xl border border-border bg-background/95 backdrop-blur-md shadow-lg"
          role="listbox"
          aria-label="Select language"
        >
