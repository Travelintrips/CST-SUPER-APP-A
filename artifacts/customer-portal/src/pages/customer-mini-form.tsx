    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-md p-8 max-w-md w-full text-center">
        ...
        <p className="text-sm text-slate-500">
          Terima kasih! Permintaan Anda telah kami terima dan akan segera diproses oleh tim kami.
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-md p-8 max-w-md w-full text-center">
        ...
        <h2 className="text-lg font-semibold text-slate-800 mb-2">Permintaan Sudah Dikirim</h2>
        <p className="text-sm text-slate-500">
          Permintaan melalui link ini sudah pernah dikirim. Tim kami sedang memproses permintaan Anda.
        </p>
      </div>
    </div>
  );
...
const INPUT_CLS = "w-full rounded-lg border border-slate-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-400";

export default function CustomerMiniFormPage() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-green-50 py-10 px-4">
      <div className="max-w-xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 mb-4">
          <div className="flex items-center gap-3 mb-1">
            ...
            <div>
              ...
              {meta.orderNumber && (
                <p className="text-xs text-emerald-600 font-medium mt-0.5">📦 Ref: {meta.orderNumber}</p>
              )}
            </div>
          </div>
          {meta.notes && (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {/* Identity */}
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
            <h2 className="text-xs font-semibold text-slate-500 uppercase tracking-wide mb-4">Informasi Pemohon</h2>
            <div className="space-y-4">
              <FormField label="Nama / Perusahaan" required>
                <input type="text" value={requesterName} onChange={e => setRequesterName(e.target.value)}
                  required placeholder="Nama Anda atau perusahaan" className={INPUT_CLS} />
              </FormField>
          ...
          <button
            ...
            className="w-full rounded-xl bg-emerald-600 hover:bg-emerald-700 disabled:bg-slate-300 text-white font-semibold py-3.5 text-sm transition-colors active:scale-95"
          >
            {submitting ? (
