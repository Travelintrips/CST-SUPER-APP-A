...
export const TRANSLATIONS: Record<string, DeepRecord> = {
  "id-ID": {
    ...
    servicesMenu: {
      ...
      seaFreight: { title: "International Sea Freight", desc: "Pengiriman laut internasional dari/ke seluruh dunia" },
      airFreight: { title: "Air Freight Forwarding", desc: "Pengiriman udara cepat ke destinasi global" },
      customs: { title: "Customs Brokerage", desc: "Pengurusan dokumen kepabeanan & bea cukai" },
      domestic: { title: "Domestic Distribution", desc: "Distribusi kargo domestik ke seluruh Indonesia" },
      warehousing: { title: "Warehousing & Fulfillment", desc: "Pergudangan & fulfillment strategis dekat pelabuhan" },
      project: { title: "Project Cargo", desc: "Pengiriman kargo proyek & alat berat skala besar" },
      consultation: { title: "Import Export Consultation", desc: "Konsultasi ekspor impor oleh ahli berpengalaman" },
    ...
    homePromo: {
      ...
      services: {
        ...
        item1Desc: "Pengiriman laut & udara internasional ke lebih dari 150 negara.",
        item2Title: "Customs Brokerage",
        item2Desc: "Pengurusan dokumen bea cukai cepat & terpercaya.",
        item3Title: "Warehousing & Fulfillment",
        item3Desc: "Fasilitas gudang modern strategis dekat pelabuhan utama.",
        item4Title: "Trucking",
        item4Desc: "Angkutan darat domestik & distribusi ke seluruh Indonesia.",
      },
      promo: {
  ...
  "en-US": {
    ...
    servicesMenu: {
      ...
      seaFreight: { title: "International Sea Freight", desc: "International ocean freight to and from anywhere in the world" },
      airFreight: { title: "Air Freight Forwarding", desc: "Fast air cargo to global destinations" },
      customs: { title: "Customs Brokerage", desc: "Customs documentation and clearance services" },
      domestic: { title: "Domestic Distribution", desc: "Domestic cargo distribution across Indonesia" },
      warehousing: { title: "Warehousing & Fulfillment", desc: "Strategic warehousing near major ports" },
      project: { title: "Project Cargo", desc: "Heavy lift and out-of-gauge project cargo shipping" },
      consultation: { title: "Import Export Consultation", desc: "Expert consultation on import-export regulations" },
    ...
    homePromo: {
      ...
      services: {
        ...
        item1Title: "Freight Shipment",
        item1Desc: "International sea & air freight to over 150 countries.",
        item2Title: "Customs Brokerage",
        item2Desc: "Fast and reliable customs document processing.",
        item3Title: "Warehousing & Fulfillment",
        item3Desc: "Modern warehouse facilities near major ports.",
        item4Title: "Trucking",
        item4Desc: "Domestic land transport & distribution across Indonesia.",
      },
      promo: {
        label: "Promos & Offers",
