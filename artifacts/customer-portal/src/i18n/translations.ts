  ...
  "id-ID": {
    ...
    homePromo: {
      ...
      services: {
        ...
        item1Title: "International Sea Freight",
        item1Desc: "Pengiriman laut ke lebih dari 150 negara dengan tarif kompetitif.",
        item2Title: "Air Freight Forwarding",
        item2Desc: "Pengiriman udara ekspres untuk kargo sensitif waktu.",
        item3Title: "Customs Brokerage",
        item3Desc: "Pengurusan dokumen bea cukai cepat & terpercaya.",
        item4Title: "Warehousing & Fulfillment",
        item4Desc: "Fasilitas gudang modern strategis dekat pelabuhan utama.",
      },
      promo: {
  ...
  "en-US": {
    ...
    homePromo: {
      ...
      services: {
        ...
        item1Title: "International Sea Freight",
        item1Desc: "Ocean shipping to over 150 countries at competitive rates.",
        item2Title: "Air Freight Forwarding",
        item2Desc: "Express air cargo for time-sensitive shipments.",
        item3Title: "Customs Brokerage",
        item3Desc: "Fast and reliable customs document processing.",
        item4Title: "Warehousing & Fulfillment",
        item4Desc: "Modern warehouse facilities near major ports.",
      },
      promo: {
        label: "Promos & Offers",
