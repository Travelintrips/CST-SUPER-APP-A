  ...
  return (
    <WouterRouter base={basePath}>
      <Switch>
        ...
        <Route path="/logistics/vendor-quote/:token" component={() => <ProtectedRoute component={LogisticsVendorQuotePage} />} />
        ...
        <Route path="/expense/:id" component={() => <ProtectedRoute component={ExpenseEditorPage} />} />
