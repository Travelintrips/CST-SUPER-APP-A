  ...
  return (
    <WouterRouter base={basePath}>
      <Switch>
        ...
        <Route
          path="/logistics/vendor-quote"
          component={LogisticsVendorQuotePage}
        />
        <Route path="/pos">
        ...
        <Route path="/sales/quotations">
          <ProtectedRoute
            component={() => <SalesDocumentsListPage kind="quote" />}
          />
        </Route>
        ...
        <Route path="/sales/orders">
          <ProtectedRoute
            component={() => <SalesDocumentsListPage kind="order" />}
          />
        </Route>
        ...
        <Route path="/purchase/rfq">
          <ProtectedRoute
            component={() => <PurchaseDocumentsListPage kind="rfq" />}
          />
        </Route>
        ...
        <Route path="/purchase/orders">
          <ProtectedRoute
            component={() => <PurchaseDocumentsListPage kind="order" />}
          />
        </Route>
