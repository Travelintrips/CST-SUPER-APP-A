...
export function AppShell({ children, noPadding }: AppShellProps) {
  ...
  const navItems: NavItem[] = [
    ...
    // ── 5. OPERATIONS / LOGISTICS ─────────────────────────────────────
    {
      ...
      children: [
        { titleKey: "Dashboard Logistik",    href: "/operational-dashboard",                    icon: LayoutDashboard },
        { titleKey: "Semua Shipment",         href: "/logistics",                                 icon: Truck },
        { titleKey: "RFQ & Quote",            href: "/logistics/rfq",                             icon: Send,        companyCodes: ["CST"] },
        { titleKey: "Trucking",               href: "/logistics/trucking-orders",                 icon: Truck,       companyCodes: ["CST"] },
        { titleKey: "Air Freight",            href: "/air-freight/orders",                        icon: Plane,       companyCodes: ["CST"] },
        { titleKey: "Ocean Freight",          href: "/logistics/ocean-freight-orders",            icon: Anchor,      companyCodes: ["CST"] },
        { titleKey: "PPJK / Customs",         href: "/logistics/freight",                         icon: ClipboardList, companyCodes: ["CST"] },
        { titleKey: "Vendor Fulfillment",     href: "/logistics/vendor-fulfillments",             icon: PackageCheck, companyCodes: ["CST"] },
        { titleKey: "Laporan Profitability",  href: "/accounting/reports/freight-profitability",  icon: TrendingUp,  roles: ["admin", "owner"] },
        { titleKey: "Settings Logistik",      href: "/logistics/margin-rules",                    icon: Settings },
      ],
    },

    // ── 5.5. MANAJEMEN DRIVER ─────────────────────────────────────────
    {
      type: "group",
      titleKey: "Manajemen Driver",
      basePath: "/logistics/drivers",
      icon: Users,
      roles: ["admin", "owner", "logistics"],
      companyCodes: ["CST"],
      children: [
        { titleKey: "Data Driver",       href: "/logistics/drivers",            icon: Users },
        { titleKey: "Performa Driver",   href: "/logistics/driver-performance", icon: BarChart2 },
        { titleKey: "Analytics Driver",  href: "/logistics/drivers/analytics",  icon: BarChart2 },
      ],
    },
