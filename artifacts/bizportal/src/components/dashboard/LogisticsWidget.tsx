...
const PHASES = [
  {
    ...
    href: "/logistic/orders?status=Order+Received",
  },
  {
    ...
    href: "/logistic/orders?status=RFQ+Sent",
  },
  {
    ...
    href: "/logistic/orders?status=In+Transit",
  },
  {
    ...
    href: "/logistic/orders?status=Invoice+Issued",
  },
];
        ...
        {!isLoading && (data?.stalled ?? 0) > 0 && (
          <div className="rounded-lg border border-destructive/30 bg-destructive/5 px-3 py-2 flex items-center gap-2">
            ...
            <p className="text-xs text-destructive">
              ...
              <Link href="/logistic/orders" className="underline underline-offset-2">
                Tinjau sekarang
              </Link>
            </p>
          </div>
