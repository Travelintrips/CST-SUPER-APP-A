...
const FLOW_STEPS = [
  {
    step: "01",
    title: "Choose Shipment Type",
    desc: "Select Import, Export, Domestic, or Door to Door",
  },
  {
    step: "02",
    title: "Select Service",
    desc: "Browse Freight, Customs, Trucking, Storage, and more",
  },
  {
    step: "03",
    title: "Calculate Estimate",
    desc: "Enter cargo details — get instant price calculation",
  },
  {
    step: "04",
    title: "Submit Order",
    desc: "Fill in company details and confirm your booking",
  },
];
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 md:py-28">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-primary-foreground/70 mb-8 leading-relaxed">
              Freight, Customs Clearance, Trucking, Warehousing &amp; End-to-End
              Logistics Services. Get an instant estimate and submit your order
              online.
            </p>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 text-center">
        <div className="bg-primary rounded-2xl p-10 text-primary-foreground">
          ...
          <p className="text-primary-foreground/70 mb-6 text-sm">
            Use our booking calculator to get an instant estimate and submit
            your order.
          </p>
          <Button
            size="lg"
        ...
        <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-muted-foreground">
              Export Import &amp; Logistic Ordering System
            </span>
          </div>
