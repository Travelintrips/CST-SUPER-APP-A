import { db, suppliersTable, logisticOrderQuotesTable } from "../lib/db/src/index.js";
...
async function main() {
  ...
  for (const q of quotes) {
    ...
    if (mp === 0) { console.log("  skip quote", q.id, "vendor", vendor.name, "- markup already 0"); continue; }
