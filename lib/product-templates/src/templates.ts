...
const templates: Record<string, ProductTemplate> = {
  ...
  rubber: {
    ...
    customFields: [
      ...
      { key: "drc", label: "DRC / Dry Rubber Content (%)", type: "number", required: true, placeholder: "93" },
      { key: "dirt_content", label: "Kadar Kotoran (%)", type: "number", required: false, placeholder: "0.08" },
      { key: "ash_content", label: "Kadar Abu (%)", type: "number", required: false, placeholder: "0.6" },
      { key: "nitrogen_pct", label: "Nitrogen (%)", type: "number", required: false, placeholder: "0.6" },
      { key: "quantity_mt", label: "Kuantitas (MT)", type: "number", required: true, placeholder: "20" },
  ...
  live_fish: {
    ...
    customFields: [
      ...
      { key: "weight_gram", label: "Bobot per Ekor (gram)", type: "number", required: false, placeholder: "500" },
      { key: "quantity_ekor", label: "Kuantitas (ekor)", type: "number", required: true, placeholder: "100" },
      { key: "origin", label: "Daerah Budidaya/Tangkapan", type: "text", required: true, placeholder: "Kepulauan Riau / Sulawesi Tengah" },
      { key: "survival_rate", label: "Survival Rate Target (%)", type: "number", required: false, placeholder: "95" },
    ],
    conditionalRules: [],
    validationRules: [
  ...
  bird_nest: {
    ...
    customFields: [
      ...
      { key: "moisture_pct", label: "Kadar Air (%)", type: "number", required: true, placeholder: "12" },
      { key: "nitrite_ppm", label: "Kadar Nitrit (ppm)", type: "number", required: true, placeholder: "30" },
      { key: "weight_gram", label: "Berat per Pieces (gram)", type: "number", required: false, placeholder: "8" },
      { key: "quantity_kg", label: "Kuantitas (kg)", type: "number", required: true, placeholder: "5" },
